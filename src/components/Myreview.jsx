  ...
  return (
    <div>
      ...
      <div className="flex min-h-full bg-white flex-col m-8 justify-center max-w-8xl   sm:px-6 lg:px-1">
        ...
        <div className="mt-8">
          <h2 className="font-bold text-xl">Asaiwok & Amadeus</h2>
          <p className="mt-4">12.02.2023 22:35</p>
        ...
        <div className="mt-8">
          <h2 className="font-bold text-xl">Ariana Heimservice</h2>
          <p className="mt-4">12.02.2023 22:35</p>
          <div className="flex justify-between lg:w-3/4 w-full mt-4">
            <p>Quality</p>
            <p>
        ...
        <div className="mt-8">
          <h2 className="font-bold text-xl">Bambus Heimservice</h2>
          <p className="mt-4">12.02.2023 22:35</p>
          <div className="flex justify-between lg:w-3/4 w-full mt-4">
            <p>Quality</p>
            <p>
